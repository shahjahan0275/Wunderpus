...
E4E_PATH = "/path/to/your/adversarialattack/encoder4editing/e4e_ffhq_encode.pt"
...
# ---- MAIN SETUP & SCRIPT ----
# ==================================================================================
PROJECT_ROOT = "/path/to/your/adversarialattack"
...
sys.path.insert(0, "/path/to/your/adversarialattack/stylegan2-pytorch")
...
def generate_wplus():
    ...
    if not os.path.exists(fs3_path):
        raise FileNotFoundError(f"fs3.npy NOT FOUND at: {fs3_path}")
...
try:
    ...
    ckpt = torch.load("/path/to/your/adversarialattack/stylegan2-pytorch/checkpoint/stylegan2-ffhq-config-f.pt", map_location=DEVICE)
...
try:
    ...
    classifier.load_state_dict(torch.load('/path/to/your/adversarialattack/stylegan2-pytorch/checkpoint/surrogate_CLIPResNet.pth'))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--realpath", type=str, default="/path/to/your/D3/data/StyleCLIP_dataset/test/0_real")
