...
##################################################
# 4. Clear torch extension cache (silently)
##################################################
rm -rf ~/.cache/torch_extensions/* >& /dev/null
...
# 7. Run attack
##################################################
python adversarialattack_clipresnet_stylegan_FOS_MIG_COW_CAMME_WB_lpips.py \
    --inputpath "/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DCT/data/StyleCLIP_dataset/fake_test" \
    --savepath "/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DCT/data/AdvImages_w_SurrogateModels/CLIPResNet_advimage/MIG_COW_GAN_lpips_DoublePhase_FixTar" \
